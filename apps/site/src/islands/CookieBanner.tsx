...
// Hydrated client:idle from BaseLayout.astro (after first paint).

import { type Component, Show, createSignal, onMount } from 'solid-js';
import { readConsent, writeConsent } from '../lib/consent';

const CookieBanner: Component = () => {
  // Default visible=false: we only show after onMount confirms there's no record.
  // This avoids hydration mismatch (Astro renders nothing for client:idle until
  // hydration kicks in, but the server pass returns an empty placeholder).
