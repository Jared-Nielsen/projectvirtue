...
**Britannia Reborn ships as a single Git monorepo.** All server, client, shared schema, tooling, content, infrastructure, and documentation live under one repository, one CI graph, one commit history.
...
edition      = "2021"
rust-version = "1.78"
authors      = ["Britannia Reborn Engineering"]
license      = "Proprietary"
