Document \#6: Persistent World & Multiplayer Architecture DocumentProject Title: Ultima VII: Britannia Reborn  
...
Britannia Reborn delivers the first true persistent Ultima world — a shared, always-evolving Britannia where thousands of Avatars can coexist without breaking the intimate, simulation-driven fantasy of the original Ultima VII.Core Design Rule:  
