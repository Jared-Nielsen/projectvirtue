...
Source heritage tags: `[U7]` *Ultima VII* party play. `[UO]` *Ultima Online* shard model. `[D&D]` tabletop role-playing convention. `[NWN]` *Neverwinter Nights* DM Client (1.x). `[BR]` original to Britannia Reborn.

---

## 1. Overview — Three Game Modes

Britannia Reborn ships three first-class modes. Each is a real product surface — none is a stretch goal, none is a placeholder.
