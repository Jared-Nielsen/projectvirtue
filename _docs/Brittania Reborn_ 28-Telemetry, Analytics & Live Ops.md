...
This document is the contract for Britannia Reborn telemetry and live-ops infrastructure. Changes to event taxonomy, MCP additions, retention, or anonymization model require an amendment to this file.
