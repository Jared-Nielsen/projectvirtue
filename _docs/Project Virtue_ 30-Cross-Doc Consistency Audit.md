...
| #19 §8.3 lists canonical NPCs `Lord Avermere, Erevan, Theran, Spark, Bron, Jaana, Geoffrey, Julia, Katrina, Sentri, Eris, Tseramed` | #3 §6 lists "Erevan, Theran, Bron, and other classic party members"; full BG roster is implied but #3 is incomplete | ✓ on names but **doc-internal completeness drift**: #3 §6 only names 3 of 12. |
...
| Question | Answer |
|---|---|
| Does #15 Phase 1 (companions: Erevan + Theran only) align with #17 Phase 1 (15 NPCs, Erevan+Theran dialogue trees)? | ✓ |
...
18. (**#3**, §6) — **Expand canonical NPC list to match the 12 names enumerated in #19 §8.3 (Lord Avermere, Erevan, Theran, Spark, Bron, Jaana, Geoffrey, Julia, Katrina, Sentri, Eris, Tseramed).** Closes the lore-completeness gap.
